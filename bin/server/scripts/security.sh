...
if ! [ -d "/etc/aspiesoft-clamav-scanner" ]; then
  ...
  sudo cp -f ./bin/apps/aspiesoft-clamav-scanner/start.sh /etc/aspiesoft-clamav-scanner
  sudo cp -f ./bin/apps/aspiesoft-clamav-scanner/aspiesoft-clamav-download-scanner.service "/etc/systemd/system"
